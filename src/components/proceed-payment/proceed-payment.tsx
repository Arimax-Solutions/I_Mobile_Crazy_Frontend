  ...
  switch (orderType) {
    case "retail-order":
      ...
      const saveOrder = async () => {
        const { subtotal, totalAfterDiscount } = calculateTotals(discount);
...
*/
    ...
    case "wholesale-order":
      ...
      const calculateTotalsWholesale = (discountValueWholesale, customerAmountValueWholesale) => {
        ...
        const totalItemPriceWholesale = wholesaleItems.reduce((sum, wholesaleItem) => sum + (parseFloat(wholesaleItem.price) || 0), 0);
